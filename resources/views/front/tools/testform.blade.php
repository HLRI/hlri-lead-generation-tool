    ...
    <div class="hlri-popup-body">
        ...
        <div class="hlri-popup-content">
            ...
            <section class="wrap-sign-in" style="display: none">
                <div style="font-size: 10px;margin-bottom: 4px">a verification code has been sent to your <span style="color: #8667ff; font-weight: bold;" id="current-phone"></span>, please enter the code below</div>
