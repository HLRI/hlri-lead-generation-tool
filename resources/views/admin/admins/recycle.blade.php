    ...
    <section class="col-lg-12">
        ...
        @if (session('restore_success'))
            <div class="alert alert_success">
                <ul>
                    <li>{{ session('restore_success') }}</li>
                </ul>
            </div>
        @endif

        @if (session('shiftdelete_success'))
            <div class="alert alert_success">
                <ul>
                    <li>{{ session('shiftdelete_success') }}</li>
                </ul>
            </div>
        @endif
        ...
        <div class="box">
            <div class="box-header">
                ...
                <div class="box-tools" style="display: flex;justify-content: space-between;width: 365px">
                    ...
                    <div style="width: 200px;display: flex">
                        <select style="height: 30px; border-top-right-radius: 5px; border-bottom-right-radius: 5px;" onchange="status_choice(this)" class="form-control" name="">
                            <option value="">انتخاب کنید</option>
                            <option value="1">حذف دائم</option>
                            <option value="2">بازیابی</option>
                        </select>
                        <button style="height: 30px; border-top-left-radius: 5px; border-bottom-left-radius: 5px;border-top-right-radius: unset; border-bottom-right-radius: unset;" id="ch"
                            class="btn btn-default">اجرا</button>
                    </div>

                    {!! Form::open(['method' => 'banner', 'action' => ['Admin\AdminController@search'], 'style' => 'display:unset']) !!}
            ...
            <div class="box-body table-responsive ">
                <table class="table table-hover  table-bordered">
                    ...
                    <tbody>
                        {!! Form::open(['method' => 'banner', 'action' => ['Admin\AdminController@all_restore'], 'style' => 'display:unset', 'id' => 'choice_all_form']) !!}
