...
@section('content')
    <section class="col-lg-12">
        ...
        @if (session('admins-create'))
            <div class="alert alert_success">
                <ul>
                    <li>{{ session('admins-create') }}</li>
                </ul>
            </div>
        @endif
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            <div class="row" style="font-size: 12px">
                                ...
                                <div class="col-md-3">
                                    <input name="menu[]" value="{{$item->id}}" type="checkbox" id="md_checkbox_{{$item->id}}" class="filled-in chk-col-amber">
    ...
    <section class="col-lg-3 connectedSortable">
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <button type="submit" class="pull-left btn btn-block btn-success" id="sendEmail">ذخیره کاربر
                </button>
            </div>
        </div>
        ...
        <div class="box">
            <div class="box-header">
                ...
                <h3 class="box-title">تصویر پروفایل</h3>
            </div>
            <div class="box-body">
                <div class="form-group" style="padding: 10px;height: 180px;max-height: 180px">
                    <label class="imgupload" onclick="filemanager.selectFile('profile-photo')">
                        <span id="upimgtext">انتخاب تصویر</span>
                        <img style="max-height: 100%" class="img-responsive" id="profile-photo-preview" src="" />
                    </label>
